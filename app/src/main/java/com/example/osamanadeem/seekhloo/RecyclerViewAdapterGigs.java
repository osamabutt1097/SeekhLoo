...
public class RecyclerViewAdapterGigs extends RecyclerView.Adapter<RecyclerViewAdapterGigs.ViewHolder>{
    ...
    public RecyclerViewAdapterGigs(Context mContext)
    {
    ...
    public RecyclerViewAdapterGigs(ArrayList<classattributes> attr, Context mContext) {
                ...
                adb.setPositiveButton("OK", new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        DatabaseReference ref = FirebaseDatabase.getInstance().getReference().getRef()
                                ...
                                .child("Gigs").child(attr.get(position).getName());
