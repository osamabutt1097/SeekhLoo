...
public class RecyclerViewAdapterClassesTutor extends RecyclerView.Adapter<RecyclerViewAdapterClassesTutor.ViewHolder>{
    ...
    public RecyclerViewAdapterClassesTutor(ArrayList<classattributes> attr, Context mContext) {
    ...
    public void onBindViewHolder(final ViewHolder holder, final int position) {
        ...
        holder.cardView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                editor.putString("s_id", attr.get(position).getStudent_id());
                editor.putString("t_id", FirebaseAuth.getInstance().getCurrentUser().getUid());
